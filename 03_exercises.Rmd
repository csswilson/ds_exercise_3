...
garden_harvest %>% 
  ...
  ggplot(aes(y = fct_rev(fct_reorder(variety, first_day)), x = total_lbs)) +
  geom_bar(stat='identity') +
  labs(title = "Tomato Variety Total Pounds by First Harvest Date", x = "Lbs", y = "") +
  geom_col(fill = "pink") +
  geom_text(aes(label = first_day, hjust = 1, nudge_x = -.5))
```
...
Trips %>% 
  ...
  labs(title = "Number of Bike Rental Events per Date", x = "", y ="")
 # theme(axis.text.y = )
```
...
Trips %>% 
  ...
  labs(title = "Number of Bike Rental Events per Weekday", x = "", y ="")
```
...
Trips %>% 
  ...
  labs(title = "Number of Bike Departures in Space", col = "Departures", x = "Longitude", y = "Latitude")
```
